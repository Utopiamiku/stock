 ...
 */
@WebServlet("/AlarmSvt")
public class AlarmSvt extends HttpServlet {
    private static final long serialVersionUID = -7704841158714057350L;
    ...
    private void start1(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        //数据总条数
        sp.setTotalRows(pd.queryAllAlarmProRows());
        //当前页数据
        sp.setT(pd.queryAlarmProByPage(sp));
        //返回数据
        JsonResult<SplitePage> json = new JsonResult<>();
        json.setObj(sp);
        json.setStateCode(200);
