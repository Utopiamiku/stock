 ...
 * @description:
 */
@WebServlet("/ProductBuySvt")
public class ProductBuySvt extends HttpServlet {
    private static final long serialVersionUID = -8751771116117396560L;

    StatisticsBuyDao stad = new StatisticsBuyDao();
