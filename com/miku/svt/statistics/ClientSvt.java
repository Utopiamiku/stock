...
import com.miku.dao.statistics.StatisticsClDao;
 ...
 * @description:
 */
@WebServlet("/ClientSvt")
public class ClientSvt extends HttpServlet {
    private static final long serialVersionUID = 3138909310933550856L;

    private StatisticsClDao stad = new StatisticsClDao();
    private ClientDao sd = new ClientDao();
    ...
    private void queryInStock(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        ArrayList<SaleStockInfo> inStockInfos = new ArrayList<>();
    ...
    private void start2(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ArrayList<ClientInfo> supplierInfos = sd.queryAllClient();
