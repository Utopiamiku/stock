...
import com.miku.dao.sell.SaleReturnDao;
 ...
 * @description:
 */
@WebServlet("/SaleReturnSvt")
public class SaleReturnSvt extends HttpServlet {

    private static final long serialVersionUID = -1762578748544523302L;
    private ClientDao cd = new ClientDao();
    private ProductDao pd = new ProductDao();
    private SplitePage sp = new SplitePage();
    private SaleReturnDao ssd = new SaleReturnDao();
    //本次进货商品集合
...
//            }
    ...
    private void start2(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        String saleStockid = "tk0000000000";
        Date d = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        String no = "tk" + sdf.format(d);
