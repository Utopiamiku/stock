...
/**
 * @author: Utopiamiku
 * @date: 2020/8/21 21:43
 * @description:
 */
@WebServlet("/PremiumSvt")
public class PremiumSvt extends HttpServlet {
    private static final long serialVersionUID = -9112235765527646307L;


    private ProductDao pd = new ProductDao();
    private SplitePage sp = new SplitePage();
    private PremiumDao bd = new PremiumDao();
    //本次进货商品集合
...
//                json.setObj(saleStockPros);
    ...
    private void start2(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        String saleStockid = "by0000000000";
        Date d = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        String no = "by" + sdf.format(d);
