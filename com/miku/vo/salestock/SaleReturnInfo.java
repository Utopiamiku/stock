...
public class SaleReturnInfo implements Serializable {
    private static final long serialVersionUID = -6282465071758650649L;
    ...
    public SaleReturnInfo() {
    }

    public SaleReturnInfo(String saleStockId, Integer clientId, String clientName, Date createDate, Double oughtBalance, Double realBalance, Double balance, String payState, Integer userId, String userName, String remark) {
        this.saleStockId = saleStockId;
        this.clientId = clientId;
        this.clientName = clientName;
        this.createDate = createDate;
